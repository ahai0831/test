...
enum nderr {
  ...
  nderr_file_data_exception,      // 40050 10029
                              // //文件数据异常，导致上传失败（正在被使用的文件重新编辑，导致）
                              //-------10000-10999为本地错误非网络相关错误码-------
                              // end
  ...
  nderr_user_not_exists,     //-8  50001	// 用户账号不存在
  ...
  nderr_userdayflowoverlimited,         // 用户当日上传流量超限
  nderr_qrcodeinvalid,                  // 二维码过了有效时间
  nderr_qrcodeloginfailed,

  // 2017.9.26 补充非法Token的错误码
  nderr_userinvalidopentoken,  // 50042 // 非法AccessToken
  nderr_refreshtokenfailed,    // 50043 // 刷新token失败

  // 2017.11.21 补充根据RedirectURL登录接口的错误码
  ...
  // 2017.11.21 补充门户登录接口的特有的错误码
  nderr_msginternalerror,

  // 2017.11.21 补充门户的刷新Token接口的错误码
  ...
  nderr_account_freezed,              // 用户账号已冻结 not used
  ...
  // 	nderr_account_freezed = -14,			// 用户账号已冻结 not
  // used
  // 	nderr_user_arrears = -15,				// 用户欠费
  // not
  // used
  ...
  // 	nderr_file_is_used = 40030,				// 文件在使用中
  // not
  // used
  // 	nderr_localfolder_not_exists = 40042,	// 本地文件夹不存在 not used
  // 	nderr_localfolder_err = 40043,			// 部分子文件传输错误
  // not
  // used
  // 	nderr_transferfolder_delete = 40044,	// 传输文件夹任务已经删除 not
  // used
  // 	nderr_downloadpicture_err = 40045,		// 下载图片数据有错误
  // not
  // used
  //////////////////////////////////////////////////////////////////////////
