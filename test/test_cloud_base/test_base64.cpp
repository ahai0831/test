...

{
  ...
  printf("base64 encode result:%s\n", str1_res1.c_str());
  printf("base64 decode result:%s\n", str1_res2.c_str());
}

TEST(Base64, Base64Test_2) {
  ...
  printf("base64 encode result:%s\n", str2_res1.c_str());
  printf("base64 decode result:%s\n", str2_res2.c_str());
  printf("base64 decode raw result:%s\n", str2_res3.c_str());
}

TEST(Base64, Base64Test_3) {
