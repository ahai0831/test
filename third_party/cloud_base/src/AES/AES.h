...
class AES {
 ...
 private:
  ...
  static int Mul(int a, int b) {
    return (a != 0 && b != 0)
               ? sm_alog[(sm_log[a & 0xFF] + sm_log[b & 0xFF]) % 255]
               : 0;
  }
 ...
 public:
  ...
  static void CharStr2HexStr(unsigned char const* pucCharStr, char* pszHexStr,
                             size_t iSize);
  static void HexStr2CharStr(char const* pszHexStr, unsigned char* pucCharStr,
                             int iSize);
