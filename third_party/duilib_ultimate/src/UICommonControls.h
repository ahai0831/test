...
public:
	...
	void Setlinkstyle(bool blinkstyle);
...
protected:
	...
	int m_iNormalFont;
	int m_iHoverFont;
	int m_iLineSpace = 0;    // 间隔
	bool m_bSignleLine = true; 
};
...
public:
    ...
    void Selected(bool bSelected,bool bSendmessage = true);
	...
	void SetShowForeImage(bool bShow = false);
	bool GetShowForeImage() const;

	void SetAutoCalcWidth(bool bAuto = false);
