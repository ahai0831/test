...
public:
	...
	//add by ligthen
	virtual void SetAllNeedHeight(int nHeight);
	virtual int GetAllNeedHeight();
protected:
	int m_nAllNeedHeight;   //显示所有项需要的高度
	int m_nAllNeedWidth;    //显示所有项需要的宽度
...
//    virtual bool SelectItem(int iIndex);
	virtual bool SelectItem(int iIndex, bool bFocus = true);
