...
public:
	...
	virtual bool SelectMultiItem(int iIndex, bool bTakeFocus = false, bool bSendMessge = true) = 0;
	virtual void SetSingleSelect(bool bSingleSel) = 0;
	virtual bool GetSingleSelect() const = 0;
	virtual bool UnSelectItem(int iIndex,bool bSendMessage = true) = 0;
...
public:
    ...
    virtual bool Select(bool bSelect = true, bool bInvalidate = true) = 0;
...
public:
	...
	void SetSelected(bool bSelected = true, bool bInvalidate = false);
	void SetShowIcon(bool bShow = true, bool bInvalidate = false);

	bool IsDragable() const;
    void SetDragable(bool bDragable);
	void SetButtonStyleIcon(bool bButtonStyleIcon);
	bool IsButtonStyleIcon() const;
	...
	LPCTSTR GetNormalIconImage() const;
	...
	RECT GetIconOffset() const;

	SIZE GetIconSize() const;      //按钮大小
...
protected:
	...
	CStdString m_sSelectedIcon;         //选择标记图
	CStdString m_sNormalIcon;      //正常标记图
	bool m_bSelected;
	RECT m_rcIconOffset;
	SIZE m_szIcon;
	CStdString m_strIconModify;
	bool m_bShowIcon;
	bool m_bButtonStyleIcon;        //button类型的Icon
};
