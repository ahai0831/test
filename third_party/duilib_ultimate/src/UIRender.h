...
public:
    ...
    static bool DrawImageString(HDC hDC, CPaintManagerUI* pManager, BitmapParam & bitmapParam, const RECT& rcItem, const RECT& rcPaint, 
        LPCTSTR pStrImage, LPCTSTR pStrModify = NULL);
	static void DrawColor(HDC hDC, CPaintManagerUI* pManager, const RECT& rc, DWORD color);
	...
	static void DrawMultLineText(HDC hDC, CPaintManagerUI* pManager, RECT& rect, int nLineSpace, CStdString pstrText, DWORD dwTextColor, int iFont, UINT uStyle);
